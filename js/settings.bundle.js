...
/***/ function(module, exports, __webpack_require__) {
	...
	var gitHubTokenField = document.getElementById('github-token');
	var gitHubLink = document.getElementById('gitHub-access-token-link');
	...
	var gitHubRateLimitOutput = document.getElementById('github-ratelimit');
	var gh = new _GitHub2.default({
		token: settings.gitHub.oauth2Token
	});
	gh.getRateLimit().then(function (rateLimit) {
		gitHubRateLimitOutput.innerHTML = rateLimit.resources.core.remaining + ' / ' + rateLimit.resources.core.limit + '<br>Resets ' + (0, _moment2.default)(new Date(rateLimit.resources.core.reset * 1000)).fromNow();
